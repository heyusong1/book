  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        @else
        <td align="center" valign="middle" class="borderbottom">         <a href="borrowing/borrow?book_message_id=<?= $v->book_message_id?>"  onFocus="this.blur()" class="add">
            <strong style="font-size: 16px; color: green">借阅</strong>
          </a>
        @endif
      </tr>
       @endforeach
