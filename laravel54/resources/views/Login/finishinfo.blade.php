  ...
  <tr>
    ...
    <form method="post" action="adduserinfo">
      <table width="100%"  border="0" id="main-tab" cellpadding="0" cellspacing="0"  align="center">
        ...
        <input type="search" name="user_info_email" value="" id="User" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">住址：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="user_info_site" id="Pwd" value=""  class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">性别：</td>
        <td align="left" valign="middle" class="">
        <input type="radio" name="user_info_sex" value="1"  id="" class="text-word">男
        <input type="radio" name="user_info_sex" value="2"  id="" class="text-word">女
        </td>
         <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">身份证：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="user_info_id_card" value="" placeholder="请输入身份证号" class="text-word">
        </td>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
