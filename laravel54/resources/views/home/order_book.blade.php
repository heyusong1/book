...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top" id="addinfo">您的位置：预约书籍</td>
  </tr>
  <tr>
   ...
   @foreach ($allorder as $k => $v)
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="center" valign="middle" class="borderright borderbottom">{{ $v->order_id }}</td>
        ...
        <td align="center" valign="middle" class="borderright borderbottom">{{ date("Y-m-d H:i:s",$v->order_time)  }}</td>
        <td align="center" valign="middle" class="borderright borderbottom">{{ $v->book_message_num }}</td>
        <td align="center" valign="middle" class="borderbottom">
          <a href="allocation?order_id=<?= $v->order_id?>" target="mainFrame"  class="add">分配</a></td>
      </tr>
      @endforeach
    </table></td>
    </tr>
